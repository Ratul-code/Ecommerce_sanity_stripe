      ...
      <div className="product-detail-container">
        <div>
          ...
          <div className="small-images-container">
            {image?.map((img,i)=>(
                <img key={i} src={urlFor(img)} className={i===index?"small-image selected-image":"small-image"} onClick={()=>setIndex(i)} alt='product' />
            ))}
        </div>
        </div>
        ...
        <div className="product-detail-desc">
            ...
            <div className="reviews">
                ...
                <div className="buttons" >
                    <button type="button" className="add-to-cart" onClick={()=>onAdd(product,parseInt(qty))} >
                        Add to Cart
                    </button>
